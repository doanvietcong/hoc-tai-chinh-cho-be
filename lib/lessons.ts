...
const moneyLessons: Lesson[] = [
  {
    ...
    questions: [
      ...
      mc(
        "m1-q4",
        "Quyển truyện tranh giá 25.000đ. Bạn muốn trả bằng ĐÚNG 2 tờ tiền. Cách nào đúng?",
        "1x20+1x5",
        [
        ...
        "Mẹo: Phải dùng đúng 2 tờ. Tổng 2 tờ phải bằng 25.000đ. Cách 1+2: 20 + 5 = 25 (đúng 2 tờ!).",
        "Đúng rồi! 20 + 5 = 25, dùng đúng 2 tờ — cách trả nhanh nhất!",
      ),
    ],
  },
  {
